...
https://gist.github.com/avieth/334201aa341d9a00c7fc/raw/56e137ca76f04062bb7b89a9fe87280fd6b61ee0/gistfile1.lhs
...
>
> module Free_monads_gistfile where
>
> import Prelude hiding (log)
> import Control.Applicative
> import Control.Monad
>
> -- -package "free (Control.Monad.Free as Control.Monad.OtherFree)"
> --import "control-monad-free" Control.Monad.Free
...
> -- https://stackoverflow.com/questions/39215103/ghc-overlapping-instances-when-generalising-addition#39215640
> -- OVERLAPPING, OVERLAPS and INCOHERENT
> instance {-# OVERLAPPABLE #-} InjectSum f (f :+: h) where
>     inject = SumL
>
> instance {-# OVERLAPPABLE #-} (InjectSum f h) => InjectSum f (g :+: h) where
>     inject = SumR . inject
>
